...
Write-Host "Installing Roblox Sky Manager..." -ForegroundColor Cyan
...
Write-Host "Installation Complete! Search for '$AppName' in your Start Menu." -ForegroundColor Green
